...
[FRAMEWORK-019](ROADMAP.md#FRAMEWORK-019) delivered DEC-004's per-item canonical storage and deterministic ledgers;
[FRAMEWORK-020](ROADMAP.md#FRAMEWORK-020) published and independently proved the `0.2.0` setup/check lifecycle; and
[FRAMEWORK-022](ROADMAP.md#FRAMEWORK-022) completed the recoverable, inverse-safe writer boundary. The immediate
priority returns to FRAMEWORK-020's public examples, feedback, and distribution. [FRAMEWORK-015](ROADMAP.md#FRAMEWORK-015),
the lightweight human review workspace, proceeds against the new candidate-diff/transaction boundary. Consumer
implementations and commercial uses remain outside VEF's product strategy.

<!-- Generated by VEF from docs/vision/. Edit canonical item files and docs/vision/_index.md, then run `vef setup`. -->
